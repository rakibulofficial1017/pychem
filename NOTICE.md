...
`data/PeriodicTableJSON.json` is derived from
[PeriodicTableJSON](https://github.com/Bowserinator/Periodic-Table-JSON)
and is licensed under the
[Creative Commons Attribution-ShareAlike 3.0 Unported License](https://creativecommons.org/licenses/by-sa/3.0/).

The Creative Commons license requires attribution and, for adaptations,
ShareAlike terms. See the license for the complete conditions.
